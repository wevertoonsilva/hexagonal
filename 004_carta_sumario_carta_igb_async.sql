-- CASE 004 - CARTA_SUMARIO via CARTA (IGB) - ASSINCRONO
-- Com rodape + GED
USE db_doc_hub;
...
INSERT INTO requisicao_documento (
    ...
    tipo_documento, canal_envio, status, etapa_atual
             ...
             'proposta:2002|doc:CARTA_SUMARIO|ref:2026-01|canal:CARTA',
             'corr-004', 'topico.carta.sumario.solicitada', 'cartao-consignado',
             'CARTA_SUMARIO', 'CARTA', 'AGUARDANDO_ASYNC', 'AGUARDAR_RETORNO_IGB'
         );
...
VALUES (@id_execucao, 'igb', JSON_OBJECT('resultado','SUCESSO','referencias',JSON_OBJECT('id_protocolo','IGB-2002')));
